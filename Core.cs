...
[assembly: MelonInfo(typeof(SafePlus.Core), "SafePlus", "1.0.1", "Denveous", null)] 
...
namespace SafePlus {
    public class Core : MelonMod {
        ...
        private const int GAME_MAX_SLOTS = 20; /*DELETE FOR UPDATES=>*/private const int SMALL_RACK_SLOTS = 6; private const int MEDIUM_RACK_SLOTS = 8; private const int LARGE_RACK_SLOTS = 12;/*<=DELETE FOR UPDATES*/
                ...
                foreach (string methodName in methodsToTry) {
                    try {
                        ...
                        if (method != null) {
                            ...
                            if (harmony == null) harmony = new HarmonyLib.Harmony("com.scheduleone.safeplus");
        ...
        private void LoadConfig() { config.SafeSlots = Mathf.Min(MelonPreferences.GetEntryValue<int>("SafePlus", "SafeSlots"), GAME_MAX_SLOTS); config.SafeRows = Mathf.Min(MelonPreferences.GetEntryValue<int>("SafePlus", "SafeRows"), GAME_MAX_SLOTS); }
        public override void OnPreferencesSaved() {
          bool changeFlag = false;
          int newSlots = MelonPreferences.GetEntryValue<int>("SafePlus", "SafeSlots");
          int newRows = MelonPreferences.GetEntryValue<int>("SafePlus", "SafeRows");
        ...
        private static bool StorageEntityInitialize_Prefix(object __instance) {
            try {
                ...
                /*DELETE FOR UPDATES=>*/if (lowerName.Contains("storagerack_small")) { slotCount = SMALL_RACK_SLOTS; displayRowCount = 2; }
                ...
                else/*<=DELETE FOR UPDATES*/ if (lowerName.Contains("safe_built")) { slotCount = config.SafeSlots; displayRowCount = config.SafeRows; }else return true;
